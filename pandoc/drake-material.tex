...
\renewcommand{\theFancyVerbLine}{\textcolor[HTML]{546E7A}{\small\arabic{FancyVerbLine}}}
...
\definecolor{BackgroundColor}{HTML}{283237}
\definecolor{TextColor}{HTML}{B3BEC4}
\definecolor{TitleColor}{HTML}{BBC6D2}
\definecolor{DrakeAccentColor}{HTML}{429488}
\definecolor{DrakeHighlightColor}{HTML}{429488}
\definecolor{BlockquoteBgColor}{HTML}{FDEFEE}
\definecolor{CodeBlockBgColor}{HTML}{1B2529}
\definecolor{CodeBlockColor}{HTML}{A9B7C6}
\definecolor{TableBorderColor}{HTML}{37474F}
\definecolor{TableEvenColor}{HTML}{2E3A40}
\definecolor{BoxColor}{HTML}{A8A8A8}
\definecolor{CheckedColor}{HTML}{65B73B}
\definecolor{UncheckedColor}{HTML}{ACB7C4}
\pagecolor{BackgroundColor}
\usepackage[colorlinks=true,allcolors=DrakeHighlightColor,hidelinks]{hyperref}
%metadata
\hypersetup{
	$if(subject)$
	$if(title-meta)$
	...
	pdfsubject={$subject$},
	$endif$
	pdfcreator={XeLaTeX via Pandoc drake-material theme},
}
%--------underline links
\makeatletter
...
\setmainfont[Extension=.ttf,Path=/usr/share/fonts/noto/NotoSans-,UprightFont=Regular,ItalicFont=Italic,BoldFont=Bold,BoldItalicFont=BoldItalic]{}
\setmonofont[Extension=.ttf,Path=/usr/share/fonts/noto/NotoSansMono-,UprightFont=Regular,BoldFont=Bold]{}
...
\newcommand{\VariableTok}[1]{\textcolor[HTML]{B3BEC4}{\FancyVerbBreakStart#1\FancyVerbBreakStop}}
